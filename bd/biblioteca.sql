...
(1, '2026-04-01', '2026-04-15', '2026-04-12'), -- No prazo
(2, '2026-04-05', '2026-04-19', '2026-04-22'), -- Atrasado e Devolvido
(3, '2026-05-01', '2026-05-15', NULL),         -- Em aberto e Atrasado
(4, '2026-05-10', '2026-05-24', '2026-05-24'), -- No prazo (limite)
(5, '2026-05-12', '2026-05-26', NULL),         -- Em aberto
(6, '2026-03-01', '2026-03-15', '2026-03-28'), -- Muito atrasado, mas devolvido
(7, '2026-05-14', '2026-05-28', NULL);         -- Em aberto
...
SELECT
    ...
    e.data_emprestimo
FROM  emprestimo e
    JOIN emprestimo_livro el on el.id_emprestimo = e.id
...
SELECT
    ...
    FROM livro l 
    JOIN categoria_livro c ON l.id_categoria_livro = c.id
    GROUP BY c.nome;
...
SELECT
    a.nome AS autor,
    COUNT(l.id_livro) AS total_livro
FROM livro_autor l
